...
public class ServerController {
    ...
    public static Label globalmatchEnded;
    ...
    private void goalLeft(){
        leftTeamStrikersList.add(globalTimer.getText()+", Забивший: "+leftTeamStriker.getText());
    ...
    private void goalRight(){
        rightTeamStrikersList.add(globalTimer.getText()+", Забивший: "+rightTeamStriker.getText());
    ...
    private void makePause(){
        CustomTimer.isPaused = !CustomTimer.isPaused;
        UserConnection.sendStatusForAll();
    }
