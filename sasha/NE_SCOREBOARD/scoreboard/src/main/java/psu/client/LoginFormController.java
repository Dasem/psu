    ...
    private void connectToServer() throws IOException, ClassNotFoundException {
        ...
        switch (connectionResult) {
            case SUCCESS:
                ...
                createMainForm(); //открывать форма
            ...
            case USERNAME_NOT_AVAILABLE:
                showAlertMessage("Подключение", "Статус", "Это Имя уже занято!", Alert.AlertType.WARNING);
                break;
            case ERROR:
                showAlertMessage("Подключение", "Статус", "unknown error", Alert.AlertType.ERROR);
                break;
            default:
